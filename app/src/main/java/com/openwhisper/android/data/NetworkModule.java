...
public final class NetworkModule {
    ...
    public NetworkModule(Context context, ApiConfig apiConfig) {
        ...
        okHttpClient =
                new OkHttpClient.Builder()
                        ...
                        .authenticator(new TokenAuthenticator(tokenStore, apiConfig))
                        .build();
    ...
    /** Builds {@code ws(s)://host/ws/social/?token=...} for the social channel. */
    public String socialWebSocketUrl() {
        HttpUrl siteRoot = apiConfig.resolve("/");
        String token = tokenStore.getAccessToken();
        HttpUrl httpUrl =
                siteRoot.newBuilder()
                        .encodedPath("/ws/social/")
                        .addQueryParameter("token", token != null ? token : "")
                        .build();
        return toWebSocketUrl(httpUrl);
    }
